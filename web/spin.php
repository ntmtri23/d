                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        ...
                        <div class="col-xs-12 col-sm-6" id="sideRound">
                            ...
                            <!-- TRÚNG GI?I -->
                            <div class="trunggiai">                            	
                                <button style="display: none;" class="btn btn-primary show-result" data-toggle="modal" data-target="#modal-2">TRÚNG GI?I</button>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content cus-mo-content">
                                      ...
                                      <div class="modal-body">
                                        <h2 class="modal-title" style="font-weight:bold;color:#3f4547;">CHÚC M?NG B?N</h2>
                                        ...
                                        <span style="font-size:16pt;">C?m on b?n dã tham gia chuong trình.</span><br>
                                        <span style="font-size:16pt;">Gi?i thu?ng s? du?c g?i d?n b?n trong th?i gian s?m nh?t.</span><br>
                                        <span style="font-size:16pt;">B?N CÒN <span style="font-weight:bold; font-size:50px;color:#ffc600;">10</span> LU?T QUAY</span>
                                      </div>                                      
                                            ...
                                            <div class="modal-dialog">                                            
                                              ...
                                              <div class="modal-content custom-modal-content">
                                                <div class="modal-header custom-modal-header">
                                                  ...
                                                  <h4 class="modal-title">NH?P THÔNG TIN</h4>
                                                </div>
                                                <div class="modal-body">
                                                    <form class="form-horizontal" role="form">
                                                        <div class="form-group custom-form-group">
                                                          ...
                                                          <div class="col-sm-9">
                                                            <input class="form-control custom-form-control" name="UserName" id="UserName" type="text" placeholder="Tên B?n">
                                                            <label style="display: none;color:red;" class="UserName_Err">Vui lòng nh?p tên c?a b?n</label>
                                                          </div>
                                                        </div>
                                                        <div class="form-group custom-form-group">
                                                          <label class="col-sm-3 control-label custom-control-label">Ði?n tho?i</label>
                                                          <div class="col-sm-9">
                                                            <input class="form-control custom-form-control" name="PhoneNumber" id="PhoneNumber" type="text" placeholder="Ði?n tho?i">
                                                            <label style="display: none;color:red;" class="PhoneNumber_Err">Vui lòng nh?p SDT c?a b?n</label>
                                                          </div>
                                                        </div>
                                                        <div class="form-group custom-form-group">
                                                          ...
                                                          <div class="col-sm-9">
                                                            ...
                                                            <label style="display: none;color:red;" class="EmailAddress_Err">Vui lòng nh?p email c?a b?n</label>
                                                          </div>
                                                        </div>
                                                        <div class="form-group custom-form-group">
                                                          <label class="col-sm-3 control-label custom-control-label">Ð?a ch? nh?n thu?ng</label>
                                                          <div class="col-sm-9">
                                                            <textarea class="form-control custom-form-textarea" rows="5" id="Address" name="Address" placeholder="Ð?a ch? nh?n thu?ng"></textarea>
                                                            <label style="display: none;color:red;" class="Address_Err">Vui lòng nh?p d?a ch? c?a b?n</label>
                                                          </div>
                                                        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 sidebar-offcanvas" id="Awars">
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <ul class="nav nav-tabs content-tabs ui-sortable-handle">
                                    ...
                                    <li><a class="icons_bangvang" href="#revenue-chart" data-toggle="tab">B?NG VÀNG</a></li>                                    
                                    <li><a class="icons_binhluan" href="#tab-comment" data-toggle="tab">BÌNH LU?N</a></li>
                                </ul>
                                <div class="tab-content no-padding">
                                    ...
                                    <div class="chart tab-pane" id="revenue-chart" style="position: relative; height: 300px; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                                        <?php foreach($resultR->LuckyDrawHistoryModel as $history) { ?>
                                            <strong><?php echo $history->UserName; ?> (<?php echo $history->PhoneNumber1; ?>)</strong> dã du?c <strong>1 ch? vàng SJC</strong> - 22 gi? tru?c<br />
                                        <?php } ?>
                                    </div>
                                        ...
                                        <div class="col-md-12" style="padding:0 5px;">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn" onclick="addComment()">     
                                                    <a href="#" class="btn btn-link custom-btn-comment"><span class="glyphicon glyphicon-comment"></span> Nh?n xét</a>
                                                </span>
                                            </div>
                                            ...
                                            <ul data-brackets-id="12674" id="sortable" class="list-unstyled ui-sortable">
                                                ...
                                                <small class="pull-right text-muted">
                                                   <span class="glyphicon glyphicon-time"></span> 7 phút tru?c</small>
                                                <br>
        ...
        if(ValidationForm())
        {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response != "1"){ 
                        alert("B?n không th? th?c hi?n quay s? vào lúc này");
                    }
                },
                error: function () {
                }
