...
var wheelImageName = "";	// File name of the image for the wheel.
var spinButtonImgOn = "/Content/Spin/img/spin_demo.png";		// Name / path to the images for the spin button.
var spinButtonImgOff = "/Content/Spin/img/spin_off.png";
var theSpeed         = 50; 		 // Controls how often the spin function is called (is miliseconds value for animation timer).
...
// ==================================================================================================================================================
function startSpin(determinedValue, luckyDrawId)
{
    resetWheel();
